...
* [User Manual](epsilla-vector-database/user-manual/README.md)
  * [Connect to a database](epsilla-vector-database/user-manual/connect-to-a-database.md)
  * [Create a new table](epsilla-vector-database/user-manual/create-a-new-table.md)
  * [Drop a table](epsilla-vector-database/user-manual/api-reference.md)
  * [Delete a database](epsilla-vector-database/user-manual/delete-a-database.md)
  * [Insert records](epsilla-vector-database/user-manual/insert-records.md)
  * [Upsert records](epsilla-vector-database/user-manual/upsert-records.md)
  * [Search the top K semantically similar records](epsilla-vector-database/user-manual/search-the-top-k-semantically-similar-records.md)
  * [Retrieve records (with filters and pagination)](epsilla-vector-database/user-manual/retrieve-records-with-filters-and-pagination.md)
  * [Delete records](epsilla-vector-database/user-manual/api-reference-1.md)
  * [Performance Tuning](epsilla-vector-database/user-manual/performance-tuning.md)
* [Advanced Topics](epsilla-vector-database/advanced-topics/README.md)
  * [Embeddings](epsilla-vector-database/advanced-topics/embeddings.md)
  * [Dense vector vs. sparse vector](epsilla-vector-database/advanced-topics/dense-vector-vs.-sparse-vector.md)
  * [Hybrid Search](epsilla-vector-database/advanced-topics/hybrid-search.md)
